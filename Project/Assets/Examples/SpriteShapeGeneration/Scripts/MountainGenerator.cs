...
public class MountainGenerator : MonoBehaviour
{
    ...
    [Tooltip("Add one or more configurations.")]
    ...
    private Vector3 _LB, _LT, _ST, _SB, _RT, _RB;
    ...
    private IEnumerator Generate()
    {
        ...
        for (int p = 1; p < _slopePointCount; p++)
        {
            ...
            {
                Debug.LogFormat("MountainGenerator: Exception: {0]" + e);
            }
